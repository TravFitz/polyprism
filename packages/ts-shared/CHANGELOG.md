...
- a071b16: Fix two relation-handling bugs in the domain-class emitters.
...
- edbd579: Surface previously-dropped emit-time diagnostics through a new `Diagnostic` interface and an optional `onDiagnostic` callback on `emitModels`.
